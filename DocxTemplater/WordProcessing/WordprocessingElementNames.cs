...
{
    internal static class WordprocessingElementNames
    {
        ...
        public static readonly XName TableProperties =      _ns + "tblPr";
        public static readonly XName TableGrid =            _ns + "tblGrid";
